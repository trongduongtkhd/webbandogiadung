                     ...
                     <tbody>
                         ...
                         <tr>
                             <td class="cart_product">
                                 <img src="{{asset('public/uploads/product/'.$cart['product_image'])}}" width="100"
                         ...
                         <tr>
                             ...
                             <td> <a class="btn btn-default check_out" href="{{url('/del-all-product')}}">Xóa tất cả giỏ
                                     hàng</a></td>
                         ...
                         <td>
                             ...
                             <p>
                                 <li> Tổng đã giảm : {{number_format($total-$total_coupon,0,',','.')}}</li>
                             </p>
